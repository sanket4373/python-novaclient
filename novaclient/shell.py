...
class OpenStackComputeShell(object):
	...
	##### Kerberos User_Key #####
        parser.add_argument('--os-email-id',
            metavar='<auth-email-id>',     
            default=utils.env('OS_EMAIL_ID'),      
            help=_('Defaults to env[OS_EMAIL_ID].'))
	parser.add_argument('--os_email_id',
	    help=argparse.SUPPRESS)
	############################
	...
	os_email_id =  args.os_email_id
        ...
        self.cs = client.Client(options.os_compute_api_version,
                os_username, os_password, os_tenant_name, email_id=os_email_id,
	...
	#print("Checking email ID##################")
	#print(os_email_id)
	#print(self.cs.email_id)
	#print(self.cs.client.email_id)
	#print("Checking email ID##################")
		...
		self.cs.client.email_id = email_id	
            elif use_pw:
